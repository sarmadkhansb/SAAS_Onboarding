...
import shape_1 from "../../../../public/assets/img/cta/cross-out.png";
import shape_2 from "../../../../public/assets/img/cta/cta-shape-5-2.png";

const business_content = {
    bg_img: "/assets/img/cta/cta-bg-5-1.png",
    sub_title: "Garrett Smith, Owner",
    title: <>SPP has been a key ingredient in our winning recipe for a successful productized service. It's easy for staff to use and customers love the client portal software for managing their service account. <br /> <span></span> </>,
    btn_text: "Read More"
                     ...
                     <div className="row g-0">
                        <div className="col-12">
                           <div className="tp-cta-five-section-box text-center">
                              ...
                              <h4 className="tp-section-title-9 pb-25">{title}</h4>
